...
step = 0
Max_step = 100
directory_path = f'/media/dc/HP ZHAN SSD/ATM/data/Task6_Sweeping/Teleoperation'
extension = '.hdf5' 
episode_idx = count_files_with_extension(directory_path, extension)
dataset_path = f'{directory_path}/episode_{episode_idx}.hdf5'
video_path=f'/media/dc/HP ZHAN SSD/ATM/data/Task6_Sweeping/Teleoperation/video/{episode_idx}'
data_dict = {
        '/observations/qpos': [],
        '/action': [],
        '/eef_qpos': [],
